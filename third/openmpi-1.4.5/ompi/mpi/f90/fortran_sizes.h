...
parameter(OMPI_SIZEOF_F90_INT1 = 4)
parameter(OMPI_SIZEOF_F90_INT2 = 4)
parameter(OMPI_SIZEOF_F90_INT4 = 4)
parameter(OMPI_SIZEOF_F90_INT8 = 4)
parameter(OMPI_SIZEOF_F90_INT16 = 4)

parameter(OMPI_SIZEOF_F90_REAL2 = 4)
parameter(OMPI_SIZEOF_F90_REAL4 = 4)
parameter(OMPI_SIZEOF_F90_REAL8 = 4)
parameter(OMPI_SIZEOF_F90_REAL16 = 4)

parameter(OMPI_SIZEOF_F90_COMPLEX8 = 4)
parameter(OMPI_SIZEOF_F90_COMPLEX16 = 4)
